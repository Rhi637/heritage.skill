...
function DifficultyBadge({ difficulty }: { difficulty: DifficultyLevel }) {
  ...
  return (
    <span style={{ padding: '2px 8px', borderRadius: 0, backgroundColor: c.bg, color: c.color, fontSize: 11, fontFamily: "'Zpix','Microsoft YaHei',monospace", imageRendering: 'pixelated', border: '1px solid rgba(255,255,255,0.1)', letterSpacing: 1 }}>
      {c.label}
    </span>
  );
}
...
const styles: Record<string, React.CSSProperties> = {
  ...
  overviewRing: { position: 'relative', flexShrink: 0 },
  overviewText: {
    position: 'absolute',
    top: '50%',
    left: '50%',
  ...
  overviewPercent: { fontWeight: 700, color: '#a5b4fc', lineHeight: 1, fontFamily: "'Zpix','Microsoft YaHei',monospace" },
  overviewLabel: { fontSize: 11, color: '#6b7280', marginTop: 4, fontFamily: "'Zpix','Microsoft YaHei',monospace" },
  overviewStats: { display: 'flex', flex: 1 },
  statItem: { textAlign: 'center' as const, flex: 1 },
  statNumber: { fontWeight: 700, color: '#e0e7ff', fontFamily: "'Zpix','Microsoft YaHei',monospace" },
  statLabel: { fontSize: 11, color: '#6b7280', marginTop: 4, fontFamily: "'Zpix','Microsoft YaHei',monospace" },
  ...
  craftRing: { position: 'relative', width: 52, height: 52, flexShrink: 0 },
  craftRingText: {
    position: 'absolute',
    top: '50%',
    left: '50%',
  ...
  craftName: { fontWeight: 600, fontFamily: "'Zpix','Microsoft YaHei',monospace", letterSpacing: 2 },
  craftSub: { fontSize: 12, color: '#6b7280', marginTop: 2, fontFamily: "'Zpix','Microsoft YaHei',monospace" },
  expandIcon: { fontSize: 12, color: '#6b7280', transition: 'transform 0.2s steps(3)' },
  pointList: {
  ...
  pointItem: { borderRadius: 0, borderLeft: '3px solid', fontFamily: "'Zpix','Microsoft YaHei',monospace" },
  pointTitle: { fontWeight: 500 },
  pointContent: { fontSize: 12, color: '#9ca3af', lineHeight: 1.6, marginTop: 4, paddingLeft: 22 },
  emptyHint: { textAlign: 'center' as const, padding: '20px 0', color: '#6b7280', fontSize: 14, fontFamily: "'Zpix','Microsoft YaHei',monospace" },
  goChatBtn: {
